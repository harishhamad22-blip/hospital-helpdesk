...
// ── LOGIN SLIDE ILLUSTRATIONS (original SVG artwork — no external image deps)
    ...
    <svg viewBox="0 0 560 420" style={{ width: '100%', height: 'auto', display: 'block' }}>
      <defs>
        ...
        <linearGradient id="lg2" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="#eef8f4" />
        </linearGradient>
      </defs>
      <rect x="0" y="0" width="560" height="420" rx="22" fill="url(#lg2)" />
      <ellipse cx="280" cy="378" rx="190" ry="16" fill={C.navy} opacity="0.06" />
      <rect x="120" y="70" width="320" height="210" rx="14" fill="url(#lg1)" />
      <rect x="140" y="90" width="280" height="150" rx="8" fill="#ffffff" opacity="0.96" />
      <rect x="255" y="282" width="50" height="26" rx="4" fill={C.navy2} />
      <rect x="210" y="308" width="140" height="12" rx="6" fill={C.navy2} opacity="0.5" />
      <rect x="158" y="200" width="18" height="26" rx="3" fill={C.gold} />
      <rect x="184" y="182" width="18" height="44" rx="3" fill={C.navy3} />
      <rect x="210" y="160" width="18" height="66" rx="3" fill={C.gold} />
      <rect x="236" y="192" width="18" height="34" rx="3" fill={C.navy3} />
      <rect x="272" y="108" width="130" height="16" rx="4" fill={C.goldL} />
      <rect x="280" y="112" width="60" height="8" rx="4" fill={C.navy} />
      <rect x="272" y="132" width="130" height="16" rx="4" fill="#eef2f7" />
      <rect x="280" y="136" width="80" height="8" rx="4" fill={C.text2} opacity="0.5" />
      <rect x="272" y="156" width="130" height="16" rx="4" fill="#eef2f7" />
      <rect x="280" y="160" width="46" height="8" rx="4" fill={C.text2} opacity="0.5" />
      <g transform="translate(388,44)">
        <rect x="0" y="0" width="118" height="86" rx="12" fill="#ffffff" stroke={C.border} strokeWidth="1.5" />
        <circle cx="20" cy="22" r="9" fill={C.greenL} />
        <path d="M15 22 l4 4 l7 -8" stroke={C.green} strokeWidth="2.4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <rect x="36" y="16" width="66" height="7" rx="3.5" fill={C.text2} opacity="0.55" />
        <rect x="36" y="28" width="46" height="6" rx="3" fill={C.text2} opacity="0.3" />
        <rect x="14" y="48" width="90" height="6" rx="3" fill="#eef2f7" />
        <rect x="14" y="60" width="70" height="6" rx="3" fill="#eef2f7" />
        <rect x="14" y="70" width="40" height="10" rx="5" fill={C.gold} opacity="0.85" />
      </g>
      <g transform="translate(56,254)">
        <rect x="0" y="0" width="108" height="66" rx="12" fill="#ffffff" stroke={C.border} strokeWidth="1.5" />
        <circle cx="26" cy="33" r="16" fill={C.goldL} />
        <path d="M18 33 l6 6 l12 -14" stroke={C.navy} strokeWidth="2.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <rect x="50" y="20" width="46" height="7" rx="3.5" fill={C.text2} opacity="0.55" />
        <rect x="50" y="32" width="34" height="6" rx="3" fill={C.text2} opacity="0.3" />
        <rect x="50" y="44" width="40" height="6" rx="3" fill={C.text2} opacity="0.3" />
      </g>
      {[[40, 40, 20], [510, 300, 26], [470, 60, 14], [30, 340, 16]].map(([cx, cy, r], i) => (
        <polygon key={i} opacity="0.18" stroke={C.gold} strokeWidth="2" fill="none"
...
function TicketIllustration() {
  return (
    <svg viewBox="0 0 560 420" style={{ width: '100%', height: 'auto', display: 'block' }}>
      ...
      <rect x="0" y="0" width="560" height="420" rx="22" fill="url(#tg2)" />
      <ellipse cx="280" cy="378" rx="190" ry="16" fill={C.navy} opacity="0.06" />
      <g transform="translate(160,60)">
        <rect x="0" y="0" width="240" height="300" rx="18" fill="#ffffff" stroke={C.border} strokeWidth="1.5" />
        <rect x="0" y="0" width="240" height="60" rx="18" fill="url(#tg1)" />
        <rect x="0" y="42" width="240" height="18" fill="url(#tg1)" />
        <rect x="20" y="20" width="120" height="10" rx="5" fill="#ffffff" opacity="0.9" />
        <rect x="20" y="36" width="80" height="7" rx="3.5" fill="#ffffff" opacity="0.6" />
        <circle cx="210" cy="30" r="16" fill={C.gold} />
        <path d="M203 30 l5 5 l10 -11" stroke="#ffffff" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        {[0, 1, 2, 3].map(i => (
          <g key={i} transform={`translate(20,${86 + i * 44})`}>
            <rect x="0" y="0" width="200" height="34" rx="8" fill={i === 1 ? C.goldL : '#f4f7fb'} />
            <rect x="14" y="12" width="120" height="8" rx="4" fill={C.text2} opacity={i === 1 ? 0.7 : 0.4} />
            <circle cx="180" cy="17" r="7" fill={i % 2 === 0 ? C.green : C.gold} opacity="0.85" />
          </g>
        ))}
      </g>
      <g transform="translate(400,28)">
        <rect x="0" y="0" width="118" height="82" rx="12" fill="#ffffff" stroke={C.border} strokeWidth="1.5" />
        <rect x="14" y="14" width="60" height="8" rx="4" fill={C.navy} opacity="0.7" />
        <rect x="14" y="30" width="90" height="6" rx="3" fill="#eef2f7" />
        <rect x="14" y="42" width="70" height="6" rx="3" fill="#eef2f7" />
        <rect x="14" y="58" width="40" height="12" rx="6" fill={C.green} opacity="0.85" />
      </g>
      <g transform="translate(40,270)">
        <rect x="0" y="0" width="108" height="70" rx="12" fill="#ffffff" stroke={C.border} strokeWidth="1.5" />
        <circle cx="26" cy="35" r="16" fill={C.goldL} />
        <path d="M18 35 l6 6 l12 -14" stroke={C.navy} strokeWidth="2.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <rect x="50" y="22" width="46" height="7" rx="3.5" fill={C.text2} opacity="0.55" />
        <rect x="50" y="34" width="34" height="6" rx="3" fill={C.text2} opacity="0.3" />
        <rect x="50" y="46" width="40" height="6" rx="3" fill={C.text2} opacity="0.3" />
      </g>
      {[[470, 340, 20], [40, 40, 16], [500, 150, 14]].map(([cx, cy, r], i) => (
        <polygon key={i} opacity="0.18" stroke={C.gold} strokeWidth="2" fill="none"
          points={Array.from({ length: 6 }).map((_, k) => {
            const ang = Math.PI / 3 * k - Math.PI / 6;
            return `${cx + r * Math.cos(ang)},${cy + r * Math.sin(ang)}`;
